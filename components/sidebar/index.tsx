...
import { Home, PanelBottom, Package, Settings2, ShoppingBag, Users, User, LogOut } from "lucide-react";
      ...
      <div className=" flex w-full flex-col bg-muted/40 ">
        ...
        sm:flex flex-col">
            <nav className="fixed flex-col items-center gap-4 px-2 py-5">
                <TooltipProvider>
                    ...
                    ">
                        ...
                        <span className="sr-only">Dasshboard Avatar</span>
                    </Link>
            ...
            <nav className="mt-auto flex flex-col items-center gap-4 px-2 py-5">
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Link  href="#" className="flex h9- w-9 shrink-0 items-center justify-center
        ...
        <div className=" sm:hidden flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
            <header className="sticky top-0 z-30 flex h-14 items-center px-4 border-b
                bg-background gap-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent
                sm:px-6
            ">
                <Sheet>
